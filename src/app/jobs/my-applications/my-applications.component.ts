...
export class MyApplicationsComponent implements OnInit {
  ...
  apps: Array<Object>;
  isAccept = true;
  constructor(private activatedRoute: ActivatedRoute, private appliationService: ApplicationService) { }
  ...
  accept(appId: string) {
    console.log('accept ' + appId)
    this.appliationService.accept(appId);
